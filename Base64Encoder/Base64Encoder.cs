...
namespace Exyll
{
    ...
    public class Base64Encoder
    {
        ...
        public Base64Encoder(char plusChar, char slashChar, bool paddingEnabled)
        {
            ...
            CharacterSet = (CharacterSetBase + plusChar + slashChar + '=').ToCharArray();
        ...
        public byte[] FromBase64(string data)
        {
            ...
            unsafe
            {
                fixed (char* _p = data.ToCharArray())
                {
                    ...
                    if (length > 2 && p2[length - 2] == '=')
                        padding = 2;
                    else if (length > 1 && p2[length - 1] == '=')
                        padding = 1;
        ...
        {
            return Default.FromBase64(data);
        }

        public static string ToBase64String(byte[] data)
        {
            return Default.ToBase64(data);
        }
    }
}
